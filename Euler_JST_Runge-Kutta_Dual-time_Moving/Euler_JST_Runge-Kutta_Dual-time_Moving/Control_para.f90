module  Control_para    !Control parameters module
    ...
    !moving
    real(8),parameter::kr = 0.0808
    real(8),parameter::rot_cen(2) = (/ 0.273,0.0/)
    real(8),parameter::att_ampl = 2.41
    integer,parameter::iter_inner=200          !the maximun iterative times 
    integer::phase = 24
    real(8)::dt_r=0.00095
