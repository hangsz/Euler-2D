subroutine meanEdge  
    !------------------------------------------
        ...
        ! discription: the average speed on the wall is set as the grid speed
        
        ! version             data                                                                      
        ! 1.1                2015.10.9   
        
        ! discription: the Mach number on the boundary has to consider the grid speed
    ...
    do i=1,nedges
        ...
        case (-1)                           ! -1 represents that the edge is the wall, using wall boundary conditions
            ...
            U_av(2,i) = 0.5 * ( U_Rot(1,iedge(1,i)) + U_Rot(1,iedge(2,i)) )                 ! the flow speed on the wall is equal to the grid speed
